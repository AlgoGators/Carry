...
if __name__ == "__main__":
    ...
    instrument_weights = dict(sp500=even_weights, gas=even_weights)

    multipliers = getMultiplierDict()

    carry_spans = [5,20,60,120]

    idm = calc_idm(INSTRUMENT_LIST)
...
returns = perc_return_dict
dailyreturns = pd.DataFrame.from_dict(returns)
dailyreturns.to_csv("combinedout.csv")
