...
def main():
    ...
    params = urllib.parse.quote_plus(fr'Driver={driver};SERVER={server};DATABASE={database};UTID={username};PWD={password}')
    ...
    for table_name in table_names:
        table_query = f"SELECT Date, [Close], [Unadj_Close] FROM [{table_name}]"
